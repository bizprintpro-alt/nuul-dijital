...
const serviceLinks = [
  { label: "Домэйн", href: "/services" },
  { label: "Хостинг", href: "/services" },
  { label: "AI Чатбот", href: "/services" },
  { label: "CRM", href: "/services" },
  { label: "И-мэйл маркетинг", href: "/services" },
];
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <Link href="/" className="mb-4 flex items-center gap-2.5">
              ...
              <span className="font-clash text-[17px] font-semibold">
                nuul<span className="text-v-soft">.mn</span>
              </span>
            </Link>
            <p className="mb-5 text-[13px] leading-relaxed text-txt-3">
              Монголын бизнесүүдийг дижитал ертөнцөд хүргэх иж бүрэн платформ.
            </p>
            {/* Social icons */}
            <div className="flex gap-2.5">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/[0.06] bg-white/[0.02] text-txt-3 transition-all hover:border-v/20 hover:text-v"
              >
            ...
            <ul className="flex flex-col gap-2.5">
              {serviceLinks.map((l) => (
                <li key={l.label}>
                  <Link
                    href={l.href}
                    className="text-[13px] text-txt-3 transition-colors hover:text-txt-2"
                  >
                    {l.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex items-center gap-2.5 text-[13px] text-txt-3">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" className="flex-shrink-0 text-v">
                ...
                <a href="tel:+97677001234" className="transition-colors hover:text-txt-2">
                  +976 7700-1234
                </a>
              </li>
              <li className="flex items-center gap-2.5 text-[13px] text-txt-3">
                ...
                <a href="mailto:info@nuul.mn" className="transition-colors hover:text-txt-2">
                  info@nuul.mn
                </a>
              </li>
              <li className="flex items-center gap-2.5 text-[13px] text-txt-3">
      ...
      <div className="border-t border-white/[0.04] px-6 py-5 sm:px-12">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-4">
            <Link href="#" className="text-[11px] text-txt-4 transition-colors hover:text-txt-3">
              Нөхцөл
            </Link>
            <Link href="#" className="text-[11px] text-txt-4 transition-colors hover:text-txt-3">
              Нууцлал
