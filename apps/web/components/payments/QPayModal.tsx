...
import { X, CheckCircle, Loader2, Clock, Smartphone, ExternalLink } from "lucide-react";
        ...
        <div className="flex items-center justify-between border-b border-white/[0.04] px-6 py-4">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-v/10">
              <Smartphone size={16} className="text-v" />
            </div>
            <div>
              <h3 className="font-syne text-base font-bold text-txt">QPay төлбөр</h3>
              <p className="text-[11px] text-txt-3">QR код уншуулж төлнө үү</p>
            </div>
          </div>
